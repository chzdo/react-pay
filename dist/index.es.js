...
function PayButton(_a) {
    ...
    return React.createElement("button", { style: buttonStyle || {}, disabled: verifying || false, onClick: function (e) {
            e.preventDefault();
            action();
        } }, verifying ? (VerifyComponent != undefined ? React.createElement(VerifyComponent, null) : 'Verifying Payment') : (text || "Pay"));
}
...
function PayStack(_a) {
    ...
    var _c = useState(false), verifying = _c[0], setVerify = _c[1];
    ...
    return React__default.createElement(React__default.Fragment, null, loaded ?
        React__default.createElement(PayButton, { buttonStyle: buttonStyle, text: text, VerifyComponent: verify === null || verify === void 0 ? void 0 : verify.Component, verifying: verifying, action: action })
